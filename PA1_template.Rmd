...
The average number of steps taken per day is `r meanSteps`.
...
The interval with the maximum number of step is `r intervalMax`, with `r stepsMax` steps.
...
In the original dataset, the total number of missing values is: `r numberNa`.
...
Through summing up "NA" values, we can see that now, the dataset has `r numberNa` missing values.
...
- The average number of steps per day with the dataset with the missing values is: `r meanSteps`. 
- The average number of steps per day with the dataset with filled-in values is: `r meanSteps2`.

- The median number of steps per day with the dataset with the missing values is: `r medianSteps`.
- The median number of steps per day with the dataset with filled-in values is: `r medianSteps2`.
